...
function FacetedItem(props: FacetedItemProps) {
  ...
  return (
    <CommandItem
      ...
      aria-checked={context.multiple ? undefined : isSelected}
    ...
    >
      {context.multiple ? (
        ...
        <span
          className={cn(
            "flex size-4 shrink-0 items-center justify-center rounded-full border border-primary/50 transition-colors",
