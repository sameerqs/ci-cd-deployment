...
import { useAsRef } from "@/components/table/hooks/use-as-ref";
import { useIsomorphicLayoutEffect } from "@/components/table/hooks/use-isomorphic-layout-effect";
		...
		<ActionBarContext.Provider value={contextValue}>
			{ReactDOM.createPortal(
				<RootPrimitive
					...
					ref={composedRef}
					className={cn(
						"fixed z-10000 rounded-lg border bg-card shadow-lg outline-none",
